...
plot_scaling_metric(FI_Bern_1000, N_Bern_1000, aggregation='median', color = "tab:orange",  title="Fisher Info, 10 image pairs (Bernoulli, 1000 trials)", ylim = 0, ax= axes[0])
#Redundancy Bern
plot_scaling_metric(100*Redundancy_Bern_1000, N_Bern_1000, aggregation='median', color = "tab:orange" , title="Information Redundancy (relative)",
                    yline = 0, ylabel = "Redundant Information,%", ax= axes[1])
